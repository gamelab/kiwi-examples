...
state.create = function () {
	...
	this.tweenFunctions = [
		{ name: "Sinusoidal In", ease: Kiwi.Animations.Tweens.Easing.Sinusoidal.In },
		{ name: "Sinusoidal Out", ease: Kiwi.Animations.Tweens.Easing.Sinusoidal.Out },
		{ name: "Sinusoidal InOut", ease: Kiwi.Animations.Tweens.Easing.Sinusoidal.InOut }
	]
...
var game = new Kiwi.Game('game-container', 'Sinusoidal', state, gameOptions);

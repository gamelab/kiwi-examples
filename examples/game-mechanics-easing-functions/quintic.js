...
state.create = function () {
	...
	this.tweenFunctions = [
		{ name: "Quintic In", ease: Kiwi.Animations.Tweens.Easing.Quintic.In },
		{ name: "Quintic Out", ease: Kiwi.Animations.Tweens.Easing.Quintic.Out },
		{ name: "Quintic InOut", ease: Kiwi.Animations.Tweens.Easing.Quintic.InOut }
	]
...
var game = new Kiwi.Game('game-container', 'Quintic', state, gameOptions);

...
state.create = function () {
	...
	this.tweenFunctions = [
		{ name: "Exponential In", ease: Kiwi.Animations.Tweens.Easing.Exponential.In },
		{ name: "Exponential Out", ease: Kiwi.Animations.Tweens.Easing.Exponential.Out },
		{ name: "Exponential InOut", ease: Kiwi.Animations.Tweens.Easing.Exponential.InOut }
	]
...
var game = new Kiwi.Game('game-container', 'Exponential', state, gameOptions);

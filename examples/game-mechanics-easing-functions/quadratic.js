...
state.create = function () {
	...
	this.tweenFunctions = [
		{ name: "Quadratic In", ease: Kiwi.Animations.Tweens.Easing.Quadratic.In },
		{ name: "Quadratic Out", ease: Kiwi.Animations.Tweens.Easing.Quadratic.Out },
		{ name: "Quadratic InOut", ease: Kiwi.Animations.Tweens.Easing.Quadratic.InOut }
	]
...
var game = new Kiwi.Game('game-container', 'Quadratic', state, gameOptions);

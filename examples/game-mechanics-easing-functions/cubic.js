...
state.create = function () {
	...
	this.tweenFunctions = [
		{ name: "Cubic In", ease: Kiwi.Animations.Tweens.Easing.Cubic.In },
		{ name: "Cubic Out", ease: Kiwi.Animations.Tweens.Easing.Cubic.Out },
		{ name: "Cubic InOut", ease: Kiwi.Animations.Tweens.Easing.Cubic.InOut }
	]
...
var game = new Kiwi.Game('game-container', 'Cubic', state, gameOptions);

...
state.create = function () {
	...
	this.tweenFunctions = [
		{ name: "Elastic In", ease: Kiwi.Animations.Tweens.Easing.Elastic.In },
		{ name: "Elastic Out", ease: Kiwi.Animations.Tweens.Easing.Elastic.Out },
		{ name: "Elastic InOut", ease: Kiwi.Animations.Tweens.Easing.Elastic.InOut }
	]
...
var game = new Kiwi.Game('game-container', 'Elastic', state, gameOptions);

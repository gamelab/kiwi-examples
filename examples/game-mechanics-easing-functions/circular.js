...
state.create = function () {
	...
	this.tweenFunctions = [
		{ name: "Circular In", ease: Kiwi.Animations.Tweens.Easing.Circular.In },
		{ name: "Circular Out", ease: Kiwi.Animations.Tweens.Easing.Circular.Out },
		{ name: "Circular InOut", ease: Kiwi.Animations.Tweens.Easing.Circular.InOut }
	]
...
var game = new Kiwi.Game('game-container', 'Circular', state, gameOptions);

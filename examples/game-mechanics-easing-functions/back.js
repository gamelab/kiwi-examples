...
state.create = function () {
	...
	this.tweenFunctions = [
		{ name: "Back In", ease: Kiwi.Animations.Tweens.Easing.Back.In },
		{ name: "Back Out", ease: Kiwi.Animations.Tweens.Easing.Back.Out },
		{ name: "Back InOut", ease: Kiwi.Animations.Tweens.Easing.Back.InOut }
	]
...
var game = new Kiwi.Game('game-container', 'Back', state, gameOptions);

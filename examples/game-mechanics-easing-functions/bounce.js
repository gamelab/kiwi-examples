...
state.create = function () {
	...
	this.tweenFunctions = [
		{ name: "Bounce In", ease: Kiwi.Animations.Tweens.Easing.Bounce.In },
		{ name: "Bounce Out", ease: Kiwi.Animations.Tweens.Easing.Bounce.Out },
		{ name: "Bounce InOut", ease: Kiwi.Animations.Tweens.Easing.Bounce.InOut }
	]
...
var game = new Kiwi.Game('game-container', 'Bounce', state, gameOptions);

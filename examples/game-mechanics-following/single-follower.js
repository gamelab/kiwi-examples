...
Follower.prototype.update = function() {
    ...
    var distance = Math.sqrt( ( ( this.x + this.width * 0.5 ) - game.input.x ) * ( ( this.x + this.width * 0.5 )  - game.input.x ) 
        + ( ( this.y + this.height * 0.5 )  - game.input.y ) * ( ( this.y + this.height * 0.5 ) - game.input.y ) );

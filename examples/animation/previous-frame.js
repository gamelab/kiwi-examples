...
state.create = function () {
	...
	this.griffon1 = new Kiwi.GameObjects.Sprite(this, this.textures.griffon, 200, 150);
	this.addChild(this.griffon1);


	this.griffon2 = new Kiwi.GameObjects.Sprite(this, this.textures.griffon, 400, 150);
...
state.nextFrame = function (){
	...
	this.griffon1.animation.prevFrame();
	...
	this.griffon2.animation.prevFrame();

...
loader.preload = function () {
    ...
    * Load assets
    **/
    this.addImage( 'background', './assets/img/plugins/uber-shader/oceanBlur.png' );

    this.addImage( 'black', './assets/img/plugins/uber-shader/black.png' );
    this.addImage( 'reflectionMap', './assets/img/plugins/uber-shader/Sphere_Ocean_ref.png' );
    this.addImage( 'irradianceMap', './assets/img/plugins/uber-shader/Sphere_Ocean_irr.png' );
...
state.create = function()
{
    ...
    this.hand.glRenderer.sphereDeviation = 1.0;
...
state.update = function()
{
    ...
    this.hand.x = this.game.stage.width * (0.5 + 0.4 * Math.sin(this.game.idealFrame * 0.015)) - this.hand.width * 0.5;
    this.hand2.x = this.game.stage.width * (0.5 + 0.4 * Math.sin(this.game.idealFrame * 0.015 + Math.PI * 0.5)) - this.hand2.width * 0.5;

    this.hand.uberEmit = this.game.idealFrame * 0.033;
    this.hand2.uberEmit = Math.sin(this.game.idealFrame * 0.017) + 0.5;

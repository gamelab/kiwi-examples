...
loader.preload = function () {
    ...
    **/
    ...
    this.addImage( 'handDiff', './assets/img/plugins/uber-shader/ZachHandGlass_diff.png' );
    this.addImage( 'handNorm', './assets/img/plugins/uber-shader/ZachHand1_normSharp.png' );
    this.addImage( 'handSpec', './assets/img/plugins/uber-shader/ZachHand1_specGlass.png' );
    this.addImage( 'handSpecMetal', './assets/img/plugins/uber-shader/ZachHand1_specMetal.png' );
...
state.create = function()
{
    ...
    // Blue Light
    lights[0].lightColor = [0.1,0.2,1.0];
    lights[0].lightIntensity = 200;
    // lights[0].lightFalloff = 0.0;
    // Red Light
    lights[1].lightColor = [1.0,0.2,0.1];
    lights[1].lightIntensity = 200;

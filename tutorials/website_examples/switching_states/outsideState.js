...
outsideState.create = function(){
    ...
    this.background = new Kiwi.GameObjects.StaticImage(this, this.textures['outside'], 0, 0);
...
outsideState.update = function(){
	...
	if (this.stateKey.isDown && this.character.transform.x > 300 && this.character.transform.x<365) {

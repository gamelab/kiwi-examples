...
interiorState.create = function(){
	...
	this.background = new Kiwi.GameObjects.StaticImage(this, this.textures['interior'], 0, 0);
    this.character = new Kiwi.GameObjects.Sprite(this, this.textures['characterSprite'], 16, 291);

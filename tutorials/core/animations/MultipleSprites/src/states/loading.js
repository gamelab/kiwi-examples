...
MultipleSprites.Loading = new KiwiLoadingScreen('Loading', 'Intro', '../../assets/img/loading/');

MultipleSprites.Loading.preload = function () {
    ...
    **/
    ...
    this.addSpriteSheet('squid', '../../assets/img/spritesheets/squid.png', 150, 117);

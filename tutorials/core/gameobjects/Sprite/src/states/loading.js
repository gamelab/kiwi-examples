...
Sprite.Loading = new KiwiLoadingScreen('Loading', 'Intro', '../../assets/img/loading/');

Sprite.Loading.preload = function () {
    ...
    **/
    ...
    this.addSpriteSheet('tree', '../../assets/img/packs/anime/tree.png', 240, 240);

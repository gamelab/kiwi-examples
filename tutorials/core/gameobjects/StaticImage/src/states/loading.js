...
StaticImage.Loading = new KiwiLoadingScreen('Loading', 'Intro', '../../assets/img/loading/');

StaticImage.Loading.preload = function () {
    ...
    **/
    ...
    this.addImage('tree', '../../assets/img/packs/anime/tree.png', 240, 240);

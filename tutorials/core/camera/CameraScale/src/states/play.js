var CameraScale = CameraScale || {};

CameraScale.Play = new Kiwi.State('Play');
...
*/
CameraScale.Play.create = function () {
...
CameraScale.Play.update = function(){
  this.camera.transform.scaleX += this.scaleStep;
  this.camera.transform.scaleY += this.scaleStep;

  if(this.camera.transform.scaleX >= 2 || this.camera.transform.scaleX <= 0.25){
    this.scaleStep *= -1;
  }
}

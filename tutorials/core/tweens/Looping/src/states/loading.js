...
Looping.Loading = new KiwiLoadingScreen('Loading', 'Intro', '../../assets/img/loading/');

Looping.Loading.preload = function () {
    ...
    **/
    ...
    this.addSpriteSheet('cat', '../../assets/img/spritesheets/griffon.png', 150, 117);

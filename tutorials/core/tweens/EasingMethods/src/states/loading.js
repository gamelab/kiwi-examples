...
EasingMethods.Loading = new KiwiLoadingScreen('Loading', 'Intro', '../../assets/img/loading/');

EasingMethods.Loading.preload = function () {
    ...
    **/
    ...
    this.addImage('bullet', '../../assets/img/static/bullet-rocket.png');

...
CreationProgrammatically.Loading = new KiwiLoadingScreen('Loading', 'Intro', '../../assets/img/loading/');

CreationProgrammatically.Loading.preload = function () {
    ...
    **/
    ...
    this.addJSON('isometricmap', '../../assets/img/isometric/isometric-tilemap.json');
    this.addSpriteSheet('blocks', '../../assets/img/isometric/blocks.png', 64, 64);

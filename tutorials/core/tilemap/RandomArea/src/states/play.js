...
RandomArea.Play = new Kiwi.State('Play');
...
*/
RandomArea.Play.create = function () {
...
RandomArea.Play.press = function(x, y){
  this.isDown = true;
...
RandomArea.Play.replace = function(x, y){
...
RandomArea.Play.update = function(){

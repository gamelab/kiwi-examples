...
var RandomArea = RandomArea || {};

RandomArea.Loading = new KiwiLoadingScreen('Loading', 'Intro', '../../assets/img/loading/');

RandomArea.Loading.preload = function () {
    ...
    **/
    ...
    this.addSpriteSheet('icons', '../../assets/img/kiwijs-icons.png', 100, 90);
     ...
     //Load in the TileMap
    this.addJSON('desertTilemap', '../../assets/img/war/json/desert-blank.json');
    ...
    this.addImage('tileoutline', '../../assets/img/misc/tileoutline.png');

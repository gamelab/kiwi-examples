...
CreationViaJSON.Loading = new KiwiLoadingScreen('Loading', 'Intro', '../../assets/img/loading/');

CreationViaJSON.Loading.preload = function () {
    ...
    **/
    ...
    this.addJSON('desertTilemap', '../../assets/img/war/json/desert-single.json');

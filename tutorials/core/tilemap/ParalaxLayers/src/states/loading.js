...
ParalaxLayers.Loading = new KiwiLoadingScreen('Loading', 'Intro', '../../assets/img/loading/');

ParalaxLayers.Loading.preload = function () {
    ...
    **/
    ...
    this.addJSON('desertTilemap', '../../assets/img/war/json/desert-paralax.json');

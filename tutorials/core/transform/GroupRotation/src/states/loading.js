...
GroupRotation.Loading = new KiwiLoadingScreen('Loading', 'Intro', '../../assets/img/loading/');

GroupRotation.Loading.preload = function () {
    ...
    **/
    ...
    this.addImage('rocket', '../../assets/img/static/bullet-rocket.png');

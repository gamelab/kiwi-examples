...
SetNumber.Loading = new KiwiLoadingScreen('Loading', 'Intro', '../../assets/img/loading/');

SetNumber.Loading.preload = function () {
    ...
    **/
    ...
    this.addSpriteSheet('german', '../../assets/img/war/characters/german-bayonet.png', 150, 117);
    this.addSpriteSheet('tank', '../../assets/img/war/characters/wwII-german-tank.png', 150, 117);

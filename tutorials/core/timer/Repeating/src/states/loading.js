...
Repeating.Loading = new KiwiLoadingScreen('Loading', 'Intro', '../../assets/img/loading/');

Repeating.Loading.preload = function () {
    ...
    **/
    ...
    this.addSpriteSheet('mujahadeen', '../../assets/img/war/characters/mujahadeen-ak47.png', 150, 117);
    this.addImage('bullet', '../../assets/img/static/bullet-normal.png');

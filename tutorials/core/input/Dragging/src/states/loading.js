...
Dragging.Loading = new KiwiLoadingScreen('Loading', 'Intro', '../../assets/img/loading/');

Dragging.Loading.preload = function () {
    ...
    **/
    ...
    this.addImage('ninja', '../../assets/img/static/ninja.png');
    this.addImage('pirate', '../../assets/img/static/pirate.png');

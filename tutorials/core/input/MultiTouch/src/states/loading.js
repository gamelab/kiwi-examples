...
MultiTouch.Loading = new KiwiLoadingScreen('Loading', 'Intro', '../../assets/img/loading/');

MultiTouch.Loading.preload = function () {
    ...
    **/
    ...
    this.addSpriteSheet('icons', '../../assets/img/kiwijs-icons.png', 100, 90);
     this.addSpriteSheet('characters', '../../assets/img/spritesheets/characters.png', 150, 117);
